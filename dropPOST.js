/*
 * dropPOST.js v 0.1 - Upload files via SendTo
 * (c) 2009 Florian Anderiasch, fa at art dash core dot org
 *     for BinaryFile and Base64 credits look below
 *
 ...
 * - PHP example, probably insecure:
 <?php
 if (isset($_POST['dropPostToken']) && $_POST['dropPostToken'] == "YOURTOKENHERE") {
 ...
 ?>
 */
postit("http://example.org/upload/", "asdf");
